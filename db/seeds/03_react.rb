...
# Add topics to it
topic = cat.topics.create!(name: 'ReactJS', slug: 'react-js', user_id: norman.id, visibility: 0)

pp "Creating 'installation' article for ReactJS"
# Add articles to that topic
article = topic.articles.create!(title: 'Installation', slug: 'installation', visibility: 0, visibility: 0)
