...
topics = ['Installation', 'Flex and Grid', 'Color System']
...
posts.each_with_index do |title, index|
  ...
  post = Post.create!(common_post_attrs.merge(title: "TailwindCSS #{title}"))
...
post1 = Post.find_by(title: 'TailwindCSS Installation - 1')
