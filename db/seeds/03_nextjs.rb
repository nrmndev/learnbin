...
topics = ['Installation', 'Express Routing', 'File Structure']
...
posts.each_with_index do |title, index|
  ...
  post = Post.create!(common_post_attrs.merge(title: "NextJS #{title}"))
...
post1 = Post.find_by(title: 'NextJS Installation - 1')
