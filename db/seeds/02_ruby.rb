...
topics = ['Installation', 'Useful Gems', 'Migration and Seeding']
...
posts.each_with_index do |title, index|
  ...
  post = Post.create!(common_post_attrs.merge(title: "Ruby #{title}"))
...
post1 = Post.find_by(title: 'Ruby Installation - 1')
